"""
All pytorch optimizers currently do not support bounds, which we need.

I took code from:
author: https://gist.github.com/arthurmensch/c55ac413868550f89225a0b9212aa4cd

and added bounds option.
"""
...
class LBFGSScipy(Optimizer):
    ...
    def __init__(self, params, max_iter=20, max_eval=None, bounds=None,
